...
- from a vector<string> read npy files

- set shape of eachblock

- batch (18,1000,1, 4096)
...
int main()
{
//    cnpy::NpyArray npy_arr = cnpy::npy_load("../npyLoader/mat.npy");
    cnpy::NpyArray npy_arr = cnpy::npy_load("/home/jiri/Lake/DAR/share/datasets/UCF-101/UCF101-rgbflow/PlayingGuitar/v_PlayingGuitar_g17_c03/fc6_0235.npy");
