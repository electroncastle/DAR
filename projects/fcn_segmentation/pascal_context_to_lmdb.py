...
def pascal_context_to_lmdb(dir_imgs,
    ...
    paths_pairs = fs.fname_pairs(paths_imgs[:10], paths_segm_labels)
...
def main(args):
    ...
    pascal_context_to_lmdb(os.path.expanduser('/home/jiri/Lake/DAR/share/datasets/VOC2010/VOCdevkit/VOC2010/JPEGImages'),
                           os.path.expanduser('/home/jiri/Lake/DAR/share/datasets/VOC2010/PASCAL-Context/trainval'),
                           os.path.expanduser('/home/jiri/Lake/DAR/share/datasets/VOC2010/PASCAL-Context/labels.txt'),
                           os.path.expanduser('/home/jiri/Lake/DAR/share/datasets/VOC2010/PASCAL-Context/59_labels.txt'),
                           'test',
                           os.path.expanduser('/home/jiri/Lake/DAR/share/datasets/VOC2010/PASCAL-Context'),
                           val_list=val_list
                           )
